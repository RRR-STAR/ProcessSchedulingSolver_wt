...
void ProcessSchedulingCalculator::createInterface() {
...
void ProcessSchedulingCalculator::setupHeader(){
...
void ProcessSchedulingCalculator::setupFooter(){
...
void ProcessSchedulingCalculator::setupInputSection(){
...
void ProcessSchedulingCalculator::setupAlgorithmSelection(){
    ...
    algorithmGroup->setStyleClass("mb-3");
...
void ProcessSchedulingCalculator::setupProcessInputTable(){
    ...
    cardHeader->setStyleClass("card-header d-flex justify-content-between align-items-center");
    ...
    addProcessButton_->setStyleClass("btn btn-outline-success"); // button 1 (add button)
    ...
    removeProcessButton_->setStyleClass("btn btn-outline-danger");     // button 2 (remove button)
    ...
    for (short int i = 0; i <= 5; ++i) { // Style header
        headerRow->elementAt(i)->setStyleClass("text-center rounded-pill");
...
void ProcessSchedulingCalculator::setupControlButtons(){
...
void ProcessSchedulingCalculator::setupResultsSection(){
...
void ProcessSchedulingCalculator::setupGanttChart(){
    ...
    cardHeader->setStyleClass("card-header text-center");
...
void ProcessSchedulingCalculator::setupStatisticsTable(){
    ...
    summaryHeader->setStyleClass("card-header text-center");
