...
void ProcessSchedulingCalculator::displayFCFSResults(){
...
void ProcessSchedulingCalculator::displaySJFResults(){
...
void ProcessSchedulingCalculator::displayPriorityResults(){
...
void ProcessSchedulingCalculator::displayRoundRobinResults(){
...
void ProcessSchedulingCalculator::displaySRTFResults(){
...
void ProcessSchedulingCalculator::displayPRPResults(){
...
void ProcessSchedulingCalculator::displayIOResults(){
    
    ganttSegments_.clear(); // clears the previous gantt chart result
    
    short int arrivedProcesses = 0, totalProcesses = processes_.size(); 
    double processIoStartTime[totalProcesses] = {0.0}, executionTime = 0.5, cpuCycle = 0.0; // cpu clock cycle 
    bool processArrived[totalProcesses] = {false}, processIoComplete[totalProcesses] = {false};
    std::vector<Process*> availableProcesses(totalProcesses, nullptr);
