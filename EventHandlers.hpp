...
// triggers whwnever the algorithm changed (drop-down menu changed)
void ProcessSchedulingCalculator::onAlgorithmChanged(){
...
void ProcessSchedulingCalculator::onProcessCountChanged(){
...
void ProcessSchedulingCalculator::onAddProcessClicked(){
...
void ProcessSchedulingCalculator::onRemoveProcessClicked(){
...
void ProcessSchedulingCalculator::onCalculateClicked(){
...
void ProcessSchedulingCalculator::onClearClicked(){
